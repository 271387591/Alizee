...
//        String url="http://120.24.234.71/im/app/login";
     ...
     * 点赞通用接口
     * 接口参数：登录时的cookie
     * type，表示点赞的分类，目前只有广告和美食，后续会增加类型，取值：广告：Advert，美食：Food
     ...
     */
    @Test
    public void testGetCommendCount() throws Exception{
        String url="http://127.0.0.1:8082/Alizee/app/getCommendCount";
        HttpPost httpost = new HttpPost(url);
        List<NameValuePair> nvps = new ArrayList<NameValuePair>();
    ...
    public void testComment() throws Exception{
        ...
        nvps.add(new BasicNameValuePair("content", "1"));
        httpost.setEntity(new UrlEncodedFormEntity(nvps, HTTP.UTF_8));
        httpost.addHeader("Cookie", "JSESSIONID=edxmvfg6ar0h;Path=/Alizee");
        DefaultHttpClient httpclient = new DefaultHttpClient();
        HttpResponse response = null;
