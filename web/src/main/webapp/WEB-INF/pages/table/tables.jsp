...
<head>
    ...
    <%--<link rel="stylesheet" href="<c:url value="/resources/css/jquery-ui-1.10.3.full.min.css"/>" />--%>
...
<%--<script src="<c:url value="/resources/lib/jquery/jqGrid/i18n/grid.locale-cn.js"/>"></script>--%>
<script src="<c:url value="/resources/lib/jquery/jqGrid/jquery.jqGrid.min.js"/>"></script>
<script src="<c:url value="/resources/lib/jquery/jqGrid/i18n/grid.locale-cn.js"/>"></script>
<%--<script src="<c:url value="/resources/lib/jquery/jquery.dataTables.bootstrap.js"/>"></script>--%>
