...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="<c:url value="/html/security/advert"/> ">广告管理</a></li>
        <li class="active"><i class="icon-user"></i>${command.id==null?'添加广告':'编辑广告'}</li>
    </ul>
</div>
...
<div class="page-content">
    <div class="page-header">
        <h1>
            <i class="icon-dashboard">${command.id==null?'添加广告':'编辑广告'}</i>
        </h1>
    </div>
    <div class="row">
        <div class="col-xs-12">
            <form class="form-horizontal" id="advertForm" enctype="multipart/form-data" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="title" value="${command.title}" id="companyName" placeholder="广告标题" data-validate="required" class="width-100" />
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-1 control-label no-padding-right" for="companyInfo">广告简介</label>
                    <div class="col-sm-4">
                        <textarea name="description" class="width-100 autosize-transition limited" data-validate="required" maxlength="1000" id="companyInfo" placeholder="广告简介">${command.description}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-1 control-label no-padding-right" for="companyProduct">是否激活</label>
                    <div class="col-sm-4">
                        <label>
                            <input id="companyProduct" name="enabled" class="ace ace-switch ace-switch-5" type="checkbox" />
                            <span class="lbl"></span>
                        </label>
                    </div>
                ...
                <div class="form-group">
                    <label class="col-sm-1 control-label no-padding-right" for="companyPhone">广告图片</label>
                    <div class="col-sm-4">
...
<script type="text/javascript">
    ...
    jQuery(function(){
        ...
        if(enabled=='true'){
            $('#companyProduct').attr('checked','checked');
        }
