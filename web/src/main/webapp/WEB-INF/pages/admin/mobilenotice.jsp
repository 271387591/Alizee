...
<%@ page import="com.ozstrategy.alipay.util.AlipayNotify" %>
...
<%
	...
	if(AlipayNotify.verify(params,mobile_rsa,pid)){//验证成功
		//////////////////////////////////////////////////////////////////////////////////////////
		//请在这里加上商户的业务逻辑程序代码
		...
		if(trade_status.equals("TRADE_FINISHED")){
            ...
            creditsOrderManager.mobileNoticeSuccess(params);
		}
        ...
        creditsOrderManager.mobileNoticeFail(params);
		out.println("fail");
	}
%>
