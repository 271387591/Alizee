...
//发送内容
        ...
        String messageUrl=applicationConfigDao.getValue(Constants.messageUrl);
...
//        }
    ...
    public static void main(String[] args){
        try{
            ...
            // 向StringBuffer追加用户名
            sb.append("name=jiangxutao");

            // 向StringBuffer追加密码（登陆网页版，在管理中心--基本资料--接口密码，是28位的）
            sb.append("&pwd=6632A1AED624A888690ED0FE6EDA");

            // 向StringBuffer追加手机号码
            sb.append("&mobile=18583910581");

            // 向StringBuffer追加消息内容转URL标准码
            sb.append("&content="+ URLEncoder.encode("您本次注册的验证码为：123455十分钟有效，请尽快使用。本条短信免费", "UTF-8"));

            //追加发送时间，可为空，为空为及时发送
            sb.append("&stime=");

            //加签名
            sb.append("&sign="+URLEncoder.encode("游游","UTF-8"));
